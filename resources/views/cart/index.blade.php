...
<div class="flex h-full flex-col overflow-y-auto bg-white shadow-xl">
                ...
                <ul role="list" class="-my-6 divide-y divide-gray-200">
                    ...
                    <div class="ml-4 flex flex-1 flex-col">
                      ...
                      <div class="flex flex-1 items-end justify-between text-sm">
                        ...
                        <div class="flex">
                          <form action="{{route('cart.remove' , $Item)}}" method="POST"></form>
                            @csrf
                            @method('DELETE')
          ...
          <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            @csrf
            @method('DELETE')
            <button type="submit" class="flex items-center justify-center rounded-md border border-transparent bg-amber-700 px-6 py-3 text-base font-medium text-white shadow-xs hover:bg-amber-700">Vider le panier</a>
            </form>
            </div>
